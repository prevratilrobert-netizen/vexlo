...
const features = [
  ...
  },
  {
    ...
    title: "Reviews to Social Posts",
    desc: "Every 5-star review automatically becomes a branded post on your Google Business Profile. Social proof on autopilot.",
    tag: "Social",
  },
  {
    icon: (
  ...
  },
  {
    ...
    desc: "Personalized, on-brand automated replies to every review — 5-star or not. Looks human. Takes zero minutes.",
    tag: "AI",
  },
  {
    icon: (
